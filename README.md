...
If the py and md files don't work, please use the HACKATHON Jupyter file to access all our code. The Path to the CLG file might be incorrect so it requires a bit of changing.
